...
Распределение баллов за семестр теперь в разделе <a href="https://m3104.nawinds.dev/#другое">Другое</a>


## Актуальное

- [C++: Лаба 3. Sandpile Model](https://classroom.github.com/a/rq_OphW2)
- [C++: Лаба 4. ArgParser](https://classroom.github.com/a/2LDzHi4o)
- [О лайвкодинге по алгосам](https://dm-aisd.yonote.ru/share/itmo_aisd_liveCoding)
...
- <a href="https://m3104.nawinds.dev/math-lecture-recordings">Записи лекций Далевской</a>
...
- [Матан](https://buildin.ai/share/e9b5fad6-6831-4067-b469-f79e5cf78d40)
  ...
  - [Ведомость](https://onedrive.live.com/view.aspx?resid=79D324962EE55ACC%2122791&authkey=!AOg_anCrTeufWXE)
...
- [Линал](https://buildin.ai/share/e9b5fad6-6831-4067-b469-f79e5cf78d40)
  ...
  - [Ведомость](https://onedrive.live.com/view.aspx?resid=79D324962EE55ACC%2121316&authkey=!AI-HtHCGZMbhsyE)
...
- [Таблица с баллами](https://docs.google.com/spreadsheets/d/13Je-WJnOh6Te_SsdaUSXmTeqDCkf6SVE8Dk1U_DKFCw/edit?usp=sharing)
...
- Коллоквиум №1
  - [Список тем к коллоквиуму](https://docs.google.com/document/u/0/d/1A1bb3gZGCUVZPhP4I-ibJlQPMGGcvsLZH-aiqk382VQ)
...
- <a href="https://m3104.nawinds.dev/point-distribution">Распределение баллов за семестр и перевод оценок</a>
...
**[Редактировать страницу](https://github.com/nawinds/m3104-links/edit/master/src/pages/index.mdx)**

import React, { useEffect, useState } from 'react';

export default function LastCommitLink() {
  const [commit, setCommit] = useState({ date: '', url: '' });

  useEffect(() => {
    fetch('https://api.github.com/repos/nawinds/m3104-links/commits')
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          const date = new Date(data[0].commit.committer.date).toLocaleString();
  ...
  return (
    <div>
      {commit.date ? (
        <p>
          <i>Последний раз страница была обновлена: <a href={commit.url} target="_blank">{commit.date}</a></i>
        </p>
      ) : (
        <p>Загружается последний коммит...</p>
      )}
    </div>
  );
}
